...
import { adminDeleteUser, adminPatchUser, getUsers } from "../controllers/admin.controller.js";
...
router.delete("/:id", verificarToken, allowRoles(ROLES.ADMIN), validarParamId, adminDeleteUser)//eliminar usuarios
